...
|---|---|---|---|---|
| 2000-2001 | dot-com + 911 | 10393 → 3411(-67%) | 19 月 | 連 18 月藍燈 |
| 2008 | 金融海嘯 | 9859 → 3955(-60%) | 12 月 | 連 16 月藍燈(史上最長) |
| 2015 | 中國股災 | 10014 → 7203(-28%) | 7 月 | 連 10 月黃藍/藍 |
...
| 月份 | TW PMI | 美 ISM | TWII 同期 | 後 6 月 TWII |
|---|---|---|---|---|
| 2008/12 | 33.7(史上最低)| 32.4 | 4591(底部區) | +57%(2009/6 = 6750)|
| 2009/3 | 49.6(反轉)| 36.3 | 5210 | +29% |
| 2020/4 | 47.6 | 41.5 | 9978 | +24%(12552 / 2020/10) |
| **2022/12** | **42.6** | 48.4 | 14138 | +13% |
| 2024/9 | 50.3 | 47.2 | 22260 | 進行中 |
        """.strip(),
    ),
    (
...
| 觸發日 | Sahm | 後 6 月 TWII | 後 12 月 TWII |
|---|---|---|---|
...
**規則**:薩姆觸發後 TWII 平均 6 月回檔 -15%(2020 為政策例外)。
        """.strip(),
    ),
    (
        "📉 殖利率曲線倒掛 — 50 年最準衰退預警",
...
| **2022/7** | **-1.1%**(史上最深) | TBD | 已 24+ 月 | 進行中(2024/7 24416 是否頂?)|

**2022 異常**:史上最深倒掛但衰退遲未到,可能 AI 資本支出 + 寬鬆財政對沖。
        """.strip(),
    ),
    (
...
|---|---|---|---|
| 2008 Q3-Q4 | -2700 億 + 期空 -8 萬口 | 8000 → 3955(-50%)| 極端 |
| 2015/8 中國股災 | -1200 億 | 10014 → 7203(-28%)| 強 |
| 2020/3 COVID | -3100 億(1 月內) | 12197 → 8523(-30%)| 極端 |
| **2022 Fed 升息** | **-1.2 兆**(全年!) | **18619 → 12629(-32%)** | **史上最大** |
| 2024/8 套利平倉 | -800 億(5 日) | 24416 → 19830(-19%)| 快速 |
        """.strip(),
    ),
    (
        "💸 韭菜指數(融資餘額)— 散戶情緒反指標",
...
|---|---|---|---|---|
| 2000/2(dot-com 頂) | 48 | 4500 億 | 10393 | -57% |
| 2007/10(海嘯前) | 42 | 3200 億 | 9809 | -60% |
| 2018/1 | 38 | 1840 億 | 11103 | -16% |
| **2021/11(觸頂)** | **45** | **2540 億** | **17840** | **-29%** |
| 2024/7 | 35 | 2500 億 | 24416 | 警戒中 |
...
|---|---|---|---|
| 2008/10 | **89.5** | 雷曼倒閉 | -34%(4 月內) |
| 2010/5 | 48 | Flash Crash | -8%(快速恢復) |
| 2018/2 | 50 | volmageddon | -10% |
| **2020/3** | **82.7**(史上新高) | COVID | -30%(2 月內) |
| 2022/9 | 36 | Fed 鷹派 | -7% |
| 2024/8/5 | 65 | 套利平倉 | -19% 同日大跌 |
...
|---|---|---|---|---|---|
| VIX | 2020/3 | 82.7 | 19/8 | **+8.0** | TWII +35% |
...
| TW PMI | 2008/12 | 33.7 | 53/4 | **-4.8** | TWII +57%(谷底)|
