...
light **5/5 PASS**（最差 protan/deutan 槽 2↔6 ΔE 9.4、一般視覺 槽 4↔7 ΔE 16.0）。**無 FAIL 殘留。**
...
**dark** 七槽與 `COLORS_7` 的驗證器結果、2026-08-26 三旗標裁示。**WD-1 實跑（2026-09-16）**＝**light 七槽**（槽 4~7 為本輪新挑）。
