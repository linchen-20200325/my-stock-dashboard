...
#: （實測至 2026-08-25）。**2026-08-27 更正**:2026-08-26 起該 streak 已中斷（當日真量 4,026,600 回來），但零星單日 0 仍會間歇出現（2019/2022/2024/2025 皆有前例，全檔 41 筆） ——
#: 也就是這欄仍然**不可信**,只是不再「恆為 0」。畫出來是一排(間歇)貼在零軸上
#: 的空白,傳達「這段期間沒有人交易」這個假訊息 —— §1:與其畫一排零,不如不畫。
