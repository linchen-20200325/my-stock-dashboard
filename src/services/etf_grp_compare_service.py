...
# A1(v19.197):`ensure_etf_rf_injected` 已遷至中性 `src/services/etf_scoring_service.py`
# (注入責任歸位「ETF 評分編排」而非「多檔比較」;單檔頁 build_etf_score_row 前也要注入,
#  解同一支 ETF Sharpe 依開頁順序給兩值的 §5 冪等破口)。此處保留 re-export 過渡,既有
# caller `from src.services.etf_grp_compare_service import ensure_etf_rf_injected` 不受影響。
from src.services.etf_scoring_service import ensure_etf_rf_injected  # noqa: F401,E402
