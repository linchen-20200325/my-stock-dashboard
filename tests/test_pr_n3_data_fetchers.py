...
class TestNewFetchersExtracted(unittest.TestCase):
    ...
    def test_fetch_institutional_importable(self):
        from daily_data_fetchers import fetch_institutional  # noqa
        import inspect
    ...
    def test_fetch_otc_importable(self):
        from daily_data_fetchers import _fetch_otc_via_finmind  # noqa
        import inspect
    ...
    def test_reexport_identity(self):
        ...
        from daily_data_fetchers import fetch_institutional as _i2, _fetch_otc_via_finmind as _o2
        self.assertIs(_i1, _i2)
        self.assertIs(_o1, _o2)

    def test_get_finmind_token_helper(self):
        """_get_finmind_token 可獨立呼叫,不爆。"""
        from daily_data_fetchers import _get_finmind_token
